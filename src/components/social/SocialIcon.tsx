import { BarChart3, Code2, Mail } from "lucide-react";
import type { SocialPlatform } from "@/data/portfolio";

export const socialIconColorMap: Record<SocialPlatform, string> = {
  email: "text-tn-green",
  linkedin: "text-tn-blue",
  github: "text-tn-fg"
};

export const socialDisplayNameMap: Record<SocialPlatform, string> = {
  github: "GitHub",
  linkedin: "LinkedIn",
  email: "Email"
};
...
export default function SocialIcon({
  ...
  switch (platform) {
    case "email":
      return <Mail size={size} className={className} strokeWidth={1.5} />;
    case "linkedin":
      return (
