...
export default function Breadcrumb({ activeFile }: Props) {
  return (
    <div className="hidden h-7 shrink-0 items-center overflow-hidden border-b border-tn-border bg-tn-bg px-3 text-[11px] text-tn-muted sm:flex sm:px-4 sm:text-[12px]">
